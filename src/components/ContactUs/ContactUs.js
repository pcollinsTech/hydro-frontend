          ...
          <div className="container">
            ...
            <div className="row">
              ...
              <div className="col-lg-4 col-md-12 col-sm-12">
                <div className="get-in-touch">
                  ...
                  <ul>
                    ...
                    <li>
                      <a href={this.props.twitterlink} className="icofont-twitter">
                        {" "}
                      </a>
                    </li>
                    <li>
                      <a href={this.props.instagramlink} className="icofont-instagram">
                        {" "}
                      </a>
                    </li>
                    <li>
                      <a href={this.props.linkedinlink} className="icofont-linkedin">
                        {" "}
                      </a>
                    </li>
                  </ul>
              ...
              <div className="col-lg-8 col-md-12 col-sm-12">
                ...
                {this.state.successMsg !== "" ? <h3 className="contactMsg">{this.state.successMsg}</h3> : null}
              </div>
            </div>
          </div>
        </section>
